class Publication < ActiveRecord::Base
	has_many :publication_users, :dependent => :destroy, inverse_of: :publication
  has_many :users, through: :publication_users

  attr_accessible :user_ids, :titulo, :revista_editorial, :arbitr_no_arbitr, :descripcion, :horas, :fecha_i, :fecha_f, :ano_periodo, :creador

 validates :revista_editorial, presence: true
 validates :titulo, presence: true
 validates :arbitr_no_arbitr, presence: true
 validates :fecha_i, presence: true
