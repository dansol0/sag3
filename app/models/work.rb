...
has_many :work_users, :dependent => :destroy, inverse_of: :work
  has_many :users, through: :work_users
  
  attr_accessible :user_ids, :tipo, :titulo, :autores, :descripcion, :horas, :fecha_i, :fecha_f, :ano_periodo, :creador
...
validates :tipo, :presence => {:message => "- Debe seleccionar el tipo de la actividad"}
 ...
 validates :autores, :presence => {:message => "- Debe ingresar los autores de la actividad"}
