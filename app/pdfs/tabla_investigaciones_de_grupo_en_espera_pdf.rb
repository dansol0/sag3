class TablaInvestigacionesDeGrupoEnEsperaPdf < Prawn::Document
 ...
 def initialize(proyects, view)
  ...
  def header (title=nil)
  	 text "LISTA DE INVESTIGACIONES DE GRUPO EN ESPARA POR APROBACIÓN", size: 15, style: :bold, align: :center
    move_down 30
