class TablaAsignaturasDePostgradoPdf < Prawn::Document
 ...
 def initialize(subjects, view)
  ...
  def header (title=nil)
  	 text "LISTA DE ASIGNATURAS DE POSTGRADO", size: 15, style: :bold, align: :center
    move_down 30
 ...
 def item_header
 	["TIPO","NOMBRE","DOCENTE RESPONSABLE"]
  ...
  def item_rows
  	...
  	@subjects.each.map do |subject|
  	 ...
  	 [subject.tipo, subject.nombre, subject.descripcion] 
  	end
